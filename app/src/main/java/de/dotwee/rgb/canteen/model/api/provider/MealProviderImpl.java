 ...
 */
public class MealProviderImpl implements MealProvider {
    private static final String TAG = MealProviderImpl.class.getSimpleName();
    ...
    public MealProviderImpl(@NonNull File cacheDir) {
    ...
    @Nullable
    @Override
    public InputStream getInputStream(@NonNull Location location, int weeknumber) {
        String filename = String.format(Locale.getDefault(), CacheHelper.FILENAME_FORMAT, location.getNameTag(), weeknumber);
